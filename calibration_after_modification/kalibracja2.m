...
global krok dlugosc1 dlugosc2 wektor_th1 wektor_th2 Polozenie_dokladne;
...
krok=15; % Okreœlam liczbê zmiennych parametrów dla których bêdzie symulowany pomiar
...
maksimum2=max(odl_dok_kal)
minimum2=min(odl_dok_kal)
% Tworzê macierz wartoœci odleg³oœci potrzebn¹ do wykreœlenia wykresu
