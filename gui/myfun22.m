...
global Polozenie_dokladne dlugosc1 kat_th1 wektor_dlugosc2 wektor_th2;
...
Polozenie_nominalne(1,:)=double(subs(XYZ_nom(1,1),{thb, zb, ab, alb,th1, z1, a1, al1, th2, z2, a2, al2, th3, z3, a3, al3},{x(1),x(2),x(3),x(4), kat_th1, dlugosc1, x(5), pi/2, wektor_th2(:),x(6),x(7),-pi/2,x(8),wektor_dlugosc2(:),x(9),x(10)}));
Polozenie_nominalne(2,:)=double(subs(XYZ_nom(2,1),{thb, zb, ab, alb,th1, z1, a1, al1, th2, z2, a2, al2, th3, z3, a3, al3},{x(1),x(2),x(3),x(4), kat_th1, dlugosc1, x(5), pi/2, wektor_th2(:),x(6),x(7),-pi/2,x(8),wektor_dlugosc2(:),x(9),x(10)}));
Polozenie_nominalne(3,:)=double(subs(XYZ_nom(3,1),{thb, zb, ab, alb,th1, z1, a1, al1, th2, z2, a2, al2, th3, z3, a3, al3},{x(1),x(2),x(3),x(4), kat_th1, dlugosc1, x(5), pi/2, wektor_th2(:),x(6),x(7),-pi/2,x(8),wektor_dlugosc2(:),x(9),x(10)}));
